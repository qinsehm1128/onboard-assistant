...
import { API_PORT, downloadDir, hostArch, hostPlatform, UI_PORT } from "./paths.ts";

const app = express();
app.use(cors());
app.use(express.json());

function parseOs(value: unknown): TargetOs {
...
const serveStatic = process.argv.includes("--serve");
if (serveStatic) {
