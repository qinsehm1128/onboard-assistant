...
export const CATALOG: CatalogItem[] = [
  ...
  },
  {
    ...
    name: "Node.js",
    category: "runtime",
    summary: "JavaScript 运行时。Claude CLI 和飞书 CLI 都用 npm 安装。装完后助手会用 node.exe 调 npm，不依赖当前窗口的 PATH。",
  ...
  },
  {
    ...
    name: "Obsidian",
    category: "ai",
    summary: "笔记与知识库。检测时会扫各磁盘、注册表和已有库，不只看 C 盘默认目录。",
  ...
  },
  {
    ...
    name: "Claudian",
    category: "ai",
    summary: "Obsidian 的 Claude 插件。按公司清单安装 2.0.15，并写入扫描到的库（含其他磁盘上的库）。",
  ...
  },
  {
    ...
    name: "飞书 CLI 技能",
    category: "collab",
    summary: "用 npm 安装官方 @larksuite/cli。检测会找 npm 全局目录和 ~/.local/bin，不依赖当前窗口 PATH。",
    docsUrl: "https://github.com/larksuite/cli",
    notes: "公司网络一般不需要 fq。装完后仍需 lark-cli auth login 登录飞书账号。",
    platforms: ["win32", "darwin"],
    dependsOn: ["node"],
    order: 10,
    kind: "cli",
